...
def score_account(user_info, cfg: dict = None) -> dict:
    ...
    cfg can optionally contain:
        'follow_ratio_multiplier': float  (default 2.0)
            If following >= multiplier × followers → flag as bot signal
    """
    if cfg is None:
        cfg = {}
    ...
    # NEW: following >= N × followers (aggressive follow ratio)
    ...
    flags["high_follow_ratio"] = (
        ...
        follower == 0 and following > 50   # follows lots, zero followers
    )
